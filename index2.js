...
function GoogleMap(position) {
  ...
  var infowindow = new google.maps.InfoWindow({
    content: 'Latitude: ' + location.lat() + '<br>Longitude: ' + location.lng()+`<br> <button onclick="saveIt(${position.coords.latitude},${position.coords.longitude})">SaVe</button>`
  });
...
function test(locationx){
var test = `https://maps.googleapis.com/maps/api/geocode/json?latlng=${locationx}`;
